...
namespace PixelPort.Server.Migrations
{
    ...
    [Migration("20251101102153_AddedUsersTableToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PixelPort.Server.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PixelPort.Server.Models.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PixelPort.Server.Models.User", b =>
                {
                    b.HasOne("PixelPort.Server.Models.UserRole", "Role")
                        .WithMany("Users")
